...
//   env   = [
//     "client=mysql",
//     "connection__host=${var.mysql_network_alias}",
//     "connection__user=${var.ghost_db_username}",
//     "connection__password=${var.mysql_root_password}",
//     "connection__database=${var.ghost_db_name}"
//   ]
//   ports {
//     internal = "2368"
